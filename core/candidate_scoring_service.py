...
class CandidateScoringService():
    ...
    def calculate_score(self, jd, candidate) -> float: 
        required_skill_score = self.skill_service.calculate_skill_score(jd.required_skills, candidate.skills,25) 
        ...
        total_score = required_skill_score + preferred_skill_score + experience_score + project_score + certification_score
